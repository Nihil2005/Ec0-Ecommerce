...
DATABASES = {
    'default': {
        ...
        'NAME': 'japandb',      # Replace 'your_database_name' with the name of your MySQL database
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'felizsas2k@gmail.com'  # Enter your Gmail email address
EMAIL_HOST_PASSWORD = 'pafu pvyh hupq zgfc'  # Enter your Gmail password
